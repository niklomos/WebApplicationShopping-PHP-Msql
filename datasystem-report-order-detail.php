...
$sql = "SELECT * FROM report_allorder WHERE id=$id";
            ...
            <div class="container pt-3">
                <div class="card ">
                    <div class="card-header " style="background-color:#2C3E50">
                        <h2 class="text-center text-light  pt-2 "> <i class="fa-solid fa-calendar-day me-2"></i>DETAIL-REPORT-ORDERS</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <img class="image-preview border border-1 border-dark" src="slip/<?php echo $row['slip_image']; ?>" alt="" width="150px">
                        </div>
                        <div class="input-group mb-3">
